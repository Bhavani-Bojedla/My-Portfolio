  ...
  return (
    <HeaderContainer style={{ position: 'fixed', top: 0, width: '100%', zIndex: 1000 }}>
      ...
      <NavMenu onClick={handleOpen} open={open}>
        ...
        <Icons>
          <Link href="https://github.com/Saravanakumar2003" target="_blank" aria-label="Link to Github">
            <FiGithub />
          </Link>
          <Link href="https://www.linkedin.com/in/saravanaramaswamy2003/" target="_blank" aria-label="Link to Linkedin">
            <FiLinkedin />
          </Link>
          <Link href="https://www.instagram.com/saravanakumar.me?utm_source=qr" target="_blank" aria-label="Instagram">
            <FiInstagram />
          </Link>
