        ...
        {projects
          ...
          .map((project) => (
            <ProjectsContent>
              ...
              />
              <div className="title">
                <Link href={project.live}> <h2>{project.title}</h2></Link>
                 
                 
               

                <div className="tags" style={{display:'flex', justifyContent:'space-around'}}>
                  <div>
                  {project.tech.map((tag) => (
                    <Image
                      width={32}
                   ...
                   <div >
                    ...
                    <b style={{color:'slateblue',marginLeft:'20px'}}>code&lt;&gt;</b></Link>
