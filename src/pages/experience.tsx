                ...
                {works.map(exp => {
                  ...
                  return (
                    <React.Fragment key={exp.id}>
                      <h2>{numbering - 1 < 10 ? `0${numbering - 1}` : numbering - 1}</h2>
                      <Tab className="tab">
            ...
            <TabContent>
              {works.map(exp => (
                <TabPanel className="tab__panel" key={exp.id}>
                  ...
                  <p style={{ marginTop: '1rem', textAlign: 'justify', marginBottom: '1rem' }}>
                    {exp.description.en
                  ...
                  <div style={{ marginTop: '1rem', marginBottom: '1rem' }} className="links">
                    ...
                    <ul>
                      {exp.tags.map(tag => (
                        <div className="tags" key={tag.name}>
                          <Image width={50} height={50} src={tag.icon} alt={tag.name} />
                          <h4>{tag.name}</h4>
                        </div>
                      ))}
                    </ul>
