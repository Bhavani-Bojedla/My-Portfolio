    ...
    <>
      ...
      <Section>
          ...
          <S.AboutContent>
            ...
            <S.AboutDescription>
              <p style={{ textAlign: 'justify' }}>
                👋 Hey there! I am Saravanakumar, 🎓 a proud graduate of Velammal Engineering College, where I am pursuing a Bachelors degree in Electronics and Communication Engineering and building a solid foundation in technology.
              </p>
              <p style={{ textAlign: 'justify' }}>
                💻 I am also an avid developer, enthusiastic volunteer, and public speaker, and I love exploring new opportunities and avenues.
              </p>
              <p style={{ textAlign: 'justify' }}>
                🎮 As a self-taught developer, I have spent countless hours sharpening my skills and learning new techniques to bring my ideas to life.
              </p>
              <p style={{ textAlign: 'justify' }}>
              ...
              <p style={{ textAlign: 'justify' }}>
                🙌 Beyond my personal pursuits, I am committed to making a positive impact in my community. I love volunteering with local organizations and provide educational resources to underprivileged kids 📚 . Its amazing to see the impact that even a small amount of time and effort can have on someone's life.
              </p>
              <p style={{ textAlign: 'justify' }}>
        ...
        <a style={{ textAlign: 'center' }}>
          Show your ❤️ by liking and commenting, Follow me on Instagram for more updates.
        </a>
        ...
        <Link href={'/#home'} legacyBehavior>
          <ButtonSecondary>
            <a>
              <ArrowLeft style={{ marginBottom: '-0.2rem' }} weight="bold" size={18} /> Go Back
            </a>
          </ButtonSecondary>
        </Link>
      </Section>
